...
public class ProdottoUtente {
    ...
    public ProdottoUtenteKey getPrimaryKey () {return primaryKey;}

    public void setPrimaryKey (ProdottoUtenteKey pk){this.primaryKey = pk;}

    public Date getDate () {return dataVisita;}

    public void setDate (Date dataVisita){this.dataVisita = dataVisita;}
